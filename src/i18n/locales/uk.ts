const uk = {
    translation: {
        ...
        // ── Per-widget payload labels (resolved by templates via label_key) ──
        widgets: {
            deviceControl: {
                label: 'Пристрої',
                summarySomeOn: '{{on}} з {{total}} увімкнено',
                summaryEmpty: 'Немає пристроїв',
            },
            lightsSwitches: {
                label: 'Освітлення',
                summarySomeOn: '{{on}} з {{total}} увімкнено',
                summaryEmpty: 'Немає світла',
            },
            deviceWatchdog: {
                label: 'Пристрої',
                periodOffline: 'офлайн',
            },
            automationEngine: {
                label: 'Автоматизації',
                periodErrors: 'помилок',
                periodRuns: 'запусків',
            },
            satelliteManager: {
                label: 'Сателіти',
                periodRegistered: 'зареєстровано',
                periodOffline: 'офлайн',
            },
            energyMonitor: {
                label: 'Енергія',
            ...
            notificationRouter: {
                label: 'Сповіщення',
                pillNoChannels: 'Немає каналів',
                pillIdle: 'Очікує',
                pillSent: 'Надіслано: {{count}}',
                rowChannels: 'Канали',
                rowRules: 'Правила',
            },
            updateManager: {
                ...
                pillChecking: 'Перевіряю',
                pillDownloading: 'Завантажую',
                pillInstalling: 'Встановлюю',
                pillAvailable: 'Доступно v{{version}}',
                pillUpToDate: 'Актуальна версія',
                rowCurrent: 'Поточна',
                rowChannel: 'Канал',
                rowLatest: 'Остання',
            },
            protocolBridge: {
                label: 'Протокольний міст',
                pillNotRunning: 'Не запущено',
                pillDisabled: 'Вимкнено',
                pillConnected: 'Підключено',
                pillMqttOffline: 'MQTT офлайн',
                rowMqttHost: 'MQTT хост',
            },
            climate: {
                label: 'Клімат',
                labelLocation: 'Клімат · {{location}}',
                modeAuto: 'Авто',
                modeCool: 'Холод',
                modeHeat: 'Тепло',
                modeDry: 'Осушення',
                stepperTemp: 'Темп.',
                secondarySetpoint: '→ задано {{temp}}°',
            },
            voiceCore: {
                label: 'Голос',
                pillReady: 'Готовий',
                pillListening: 'Слухаю',
                pillSpeaking: 'Говорю',
                pillError: 'Помилка',
                pillPrivacyOn: 'Режим приватності',
                rowWakeWord: 'Wake-слово',
                rowSttLang: 'Мова STT',
                rowPrivacy: 'Приватність',
                alwaysOn: 'без wake-слова',
                privacyOn: 'увімкнено',
                privacyOff: 'вимкнено',
            },
            backupManager: {
                label: 'Бекап',
                pillScheduled: 'За розкладом',
                pillManualOnly: 'Тільки вручну',
                rowLatest: 'Останній',
                rowTotal: 'Усього',
                actionBackupNow: 'Створити зараз',
            },
            presenceDetection: {
                label: 'Присутність',
                summaryNoUsers: 'Немає користувачів',
                summaryAllAway: 'Усі поза домом',
                summaryAllHome: 'Усі вдома',
                summarySomeHome: '{{home}}/{{total}} вдома',
                lastSeenJustNow: 'щойно',
                lastSeenMinutes: '{{count}} хв тому',
                lastSeenHours: '{{count}} год тому',
                lastSeenDays: '{{count}} д тому',
                emptyText: 'Немає зареєстрованих користувачів',
                stateHome: 'Вдома',
                stateAway: 'Не вдома',
                stateUnknown: '—',
            },
            weatherService: {
                feelsLike: 'відчувається {{temp}}°',
            ...
            mediaPlayer: {
                ...
                source_podcast: 'подкаст',
                source_stream: 'потік',
            },
            clock: {
                nextAlarm: 'Наступний будильник',
        ...
        security: {
            title: 'Захист інтерфейсу',
            desc: 'Оберіть, які дії на дашборді вимагають підтвердження PIN-кодом.',
            editModePin: 'Запитувати PIN для режиму редагування',
            editModePinDesc: 'Перед входом у режим редагування віджетів буде запитано PIN.',
            deviceTogglePin: 'Запитувати PIN для кожного керування пристроєм',
            deviceTogglePinDesc: 'Кожен клік по світлу / вимикачу / термостату вимагає PIN. Незручно для щоденного використання — лише для дуже публічних установок.',
            kioskMode: 'Режим кіоску (лише перегляд дашборду)',
            kioskModeDesc: 'Будь-які зміни на дашборді заблоковано до введення PIN. Перекриває прапорець режиму редагування вище.',
            saveFailed: 'Не вдалося зберегти налаштування безпеки.',
        },

        ttsSuggest: {
            title: 'Голос асистента не співпадає з мовою інтерфейсу',
            body: 'Мова інтерфейсу — {{ui}}, а асистент говорить {{tts}}.',
            installed: '(встановлено)',
            needsDownload: 'Встановіть {{voice}} у налаштуваннях голосу, щоб використовувати.',
            noMatch: 'Для мови «{{lang}}» зараз немає жодного встановленого чи доступного голосу Piper.',
            activate: 'Активувати відповідний голос',
            activating: 'Активація…',
            activated: 'Голос активовано: {{voice}}',
            activateFailed: 'Не вдалося активувати голос. Зайдіть у налаштування голосу.',
            keep: 'Залишити поточний',
            optOutLabel: 'Не пропонувати зміну голосу при зміні мови',
        },
