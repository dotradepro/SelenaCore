...
Маршрутизатор інтентів використовує 5-рівневий каскад. Кожен рівень перевіряється по порядку; перший збіг виграє. Уся pipeline працює **англійською внутрішньо** — не-англійський ввід перекладається Tier 3 (LLM) у англійський `intent` + англійські `params`. Українських / російських / німецьких FastMatcher-патернів немає за дизайном.
