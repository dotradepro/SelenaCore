...
|--------|-----|-----------------|------|
| `PLATFORM_API_URL` | `str` | `https://selenehome.tech/api/v1` | URL хмарної платформи API SelenaCore. |
...
| Ключ | Тип | За замовчуванням | Опис |
|------|-----|-----------------|------|
| `api_url` | `str` | `https://selenehome.tech/api/v1` | Endpoint API хмарної платформи. |
