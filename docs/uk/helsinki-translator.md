...
## Пропустити конвертацію — готові архіви на GitHub

Перш ніж запускати Colab, перевір супутнє репо —
**[dotradepro/selena-helsinki-models](https://github.com/dotradepro/selena-helsinki-models)** —
чи немає вже готового архіву для твоєї мови. Зараз є:

| Мова | Тека | Release |
|---|---|---|
| Українська (`uk`) | [`languages/uk/`](https://github.com/dotradepro/selena-helsinki-models/tree/main/languages/uk) | [v1.0.0](https://github.com/dotradepro/selena-helsinki-models/releases/tag/v1.0.0) |

Завантаж обидва архіви, відкрий у SelenaCore **Налаштування →
Переклад → Встановити власну Helsinki-модель**:

1. Введи код мови `uk`.
2. Обери напрямок `input`, завантаж `helsinki-uk-en-input.tar.gz`, натисни **Встановити**.
3. Обери напрямок `output`, завантаж `helsinki-en-uk-output.tar.gz`, натисни **Встановити**.
4. Натисни **Активувати**.

Все — пропусти до кроку верифікації. Решта цього документа описує, як
самому сконвертувати нову мовну пару (і потім поділитися нею у репо
моделей).
